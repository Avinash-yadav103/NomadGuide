        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-4">
              ...
              <span className="ml-2 text-xl font-bold text-white">NomadGuide</span>
            </div>
            <p className="text-gray-400 mt-2 mb-4">
              Helping travelers create unforgettable journeys with personalized itineraries and local insights.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-400 hover:text-white transition-colors duration-200">Travel Guides</a></li>
          ...
          <div>
            ...
            <p className="text-gray-400 mb-4">Get weekly travel inspiration, exclusive deals, and destination guides straight to your inbox.</p>
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-2">
              ...
              <button 
                type="submit"
                className="bg-indigo-600 hover:bg-indigo-700 transition-colors duration-200 text-white px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                Subscribe
              </button>
            </form>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} NomadGuide. All rights reserved.
            </p>
